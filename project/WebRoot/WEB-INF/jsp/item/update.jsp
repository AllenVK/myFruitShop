...
<head>
    ...
    <script type="text/javascript" src="${ctx}/resource/ueditor/ueditor.config.js"></script>  <%--这里需要注意 config.js和all.min.js的引入顺序--%>
            ...
            <form action="${ctx}/item/exUpdate" method="post" class="form-x" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        ...
                        <div class="tips"><img src="${obj.url1}"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url2}"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url3}"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url4}"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url5}"></div>
                    </div>
                </div>
                <div class="form-group">
