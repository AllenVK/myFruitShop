        ...
        <div class="width1200 hidden_yh center_yh">
            ...
            <div class="bj_fff hidden_yh" style="width: 1200px;border: 1px solid #ddd;margin-top: 30px;padding: 50px;">
                <div class="width100" style="height: 32px;line-height: 32px;margin: 15px;">
                    <div class="left_yh font16 tright" style="width: 120px;"><font>姓名：</font></div>
                    <input type="text" id="name" style="width: 243px;border: 1px solid #ddd;outline: none;height: 30px;text-indent: 10px;">
                </div>
                <div class="width100" style="height: 32px;line-height: 32px;margin: 15px;">
                    <div class="left_yh font16 tright" style="width: 120px;"><font>联系方式：</font></div>
                    <input type="text" id="phone" style="width: 243px;border: 1px solid #ddd;outline: none;height: 30px;text-indent: 10px;">
                </div>
                <div class="width100" style="height: 100px;line-height: 100px;margin: 15px;">
                    <div class="left_yh font16 tright" style="width: 120px;"><font>留言内容：</font></div>
                    <textarea rows="10" cols="60" id="content" style="width: 700px;border: 1px solid #ddd;outline: none;height: 100px;text-indent: 10px;"></textarea>
                </div>
                <div class="width100" style="height: 32px;line-height: 32px;margin: 15px;">
