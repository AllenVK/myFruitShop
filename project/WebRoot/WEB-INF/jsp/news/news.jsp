    ...
    <form action="${ctx}/news/findBySql" id="listForm" method="post">
        <div class="padding border-bottom">
            <ul class="search" style="padding-left: 10px">
                <li>
                    <a class="button border-main icon-plus-square-o" href="${ctx}/news/add">新增公告</a>
                </li>
                <li>
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="1">
            <tr>
                ...
                <td>
                    <a class="button border-main" href="${ctx}/news/update?id=${data.id}"><span class="icon-edit">修改公告</span> </a>
                    <a class="button border-red" href="${ctx}/news/delete?id=${data.id}"><span class="icon-trash-o">删除公告</span> </a>
                </td>
            </tr>
        </c:forEach>
        <tr>
