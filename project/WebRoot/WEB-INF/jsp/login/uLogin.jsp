                ...
                <form action="${ctx}/login/uToLogin" method="post">
                    ...
                    <div class="center_yh hidden_yh" style="width: 336px;">
                        ...
                        <div class="width100 box-sizing hidden_yh" style="height: 44px;border: 1px solid #c9c9c9;margin-bottom: 34px;">
                            ...
                            <input type="password" placeholder="请输入用户密码" name="passWord" value="" style="border:0;width: 292px;height: 42px;font-size: 16px;text-indent: 22px;">
                        </div>
                        <input type="submit" value="登录" class="center_yh" style="width: 100%;height: 43px;font-size: 16px;background-color: #dd4545;outline: none;border: 0;color: #fff;cursor: pointer;" />
                    </div>
                </form>
            </div>
        </div>
